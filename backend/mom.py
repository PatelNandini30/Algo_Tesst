...
CE_M = {'segment':'OPTIONS','option_type':'CE','position':'SELL','lots':1,'expiry':'MONTHLY',
...
PE_Y = {'segment':'OPTIONS','option_type':'PE','position':'SELL','lots':1,'expiry':'YEARLY',
...
p = dict(index='NIFTY', from_date='2019-01-01', to_date='2026-06-30',
         ...
         rollover_cadence='monthly', yearly_exit_months_before=1, yearly_roll_months=['12'],
         ...
         filter_segments=[{"start":"2019-03-29","end":"2019-04-24"},{"start":"2019-09-30","end":"2020-02-26"},
                          {"start":"2022-07-29","end":"2022-11-30"},{"start":"2023-04-28","end":"2025-01-02"},
                          {"start":"2025-03-28","end":"2026-02-23"},{"start":"2026-04-30","end":"2026-05-25"}],
         legs=[CE_M, PE_Y])
